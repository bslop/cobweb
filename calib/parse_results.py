...
PROBES = [
    ...
    ("m68kbus", 0, "68000 DRAM read stream: A=OP idle, B=OP scanning full screen"),
...
def reps_of(name):
    return {
        ...
        "blitsm": 128, "blitbg": 128, "blittex1": 128, "blittexq": 128, "m68kbus": 32, "lddramj": 512, "lddramop": 512,
